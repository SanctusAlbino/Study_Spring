...
<table class="tb-row">
	<colgroup>
		...
		<tr>
			<th>사번</th><td>${vo.employee_id }</td>
		</tr>
		<tr>
			<th>사원명</th><td>${vo.name }</td>
		</tr>
		<tr>
			<th>이메일</th><td>${vo.email }</td>
		</tr>
		<tr>
			<th>전화번호</th><td>${vo.phone_number }</td>
		</tr>
		<tr>
			<th>급여</th><td><fmt:formatNumber value="${vo.salary }"/> </td>
		</tr>
		<tr>
			<th>입사일자</th><td>${vo.hire_date }</td>
		</tr>
		<tr>
			<th>부서</th><td>${vo.department_name}</td>
		</tr>
		<tr>
